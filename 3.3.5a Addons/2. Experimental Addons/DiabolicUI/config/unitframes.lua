...
local config = {
	...
	visuals = {
		...
		--Shaggymod | All sizes for the PlayerGlobes were "size = { 256, 256 }"
		artwork = {
			health = {
				backdrop = {
					--size = { 192, 192 },
					...
					--position = { "BOTTOMLEFT", -192 + (192 - 160)/2 -8, -(192 - 160)/2 -6},
			...
			power = {
				backdrop = {
					...
					--position = { "BOTTOMRIGHT", 192 - (192 - 160)/2 +8, -(192 - 160)/2 -6},
					texture = path .. [[textures\DiabolicUI_PlayerGlobes_150x150_Backdrop.tga]],
					color = { 0, 0, 0, 1 }
				},
				overlay = {
