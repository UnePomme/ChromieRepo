...
--*Shaggymod* Default value | local bar_inset, sidebar_inset = 10, 20 
local bar_inset, sidebar_inset = 36, 20 
--*Shaggymod* Default value | artwork_offscreen = 20
...
-- skull stuff
--*Shaggymod* Default value | local skulloffset = 78
local skulloffset = 7800

-- artwork offsets (angel + demon)
--[[*Shaggymod* Default values
local angel_offset = 128 + 64
local demon_offset = 128 + 64 + 4 
I moved them off screen instead of disable to avoid errors
--]]
local angel_offset = 110 + 64
local demon_offset = 110 + 64 + 4 
