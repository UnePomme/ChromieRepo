...
function FIZ_InitDeFactionGains()
	...
	-- Thorium Brotherhood
	FIZ_AddQuest("Thorium Brotherhood", 4, 4, "[45] Nachschub an feurigem Fluxus: K\195\182nigsblut", 25, {["Incendosaurierschuppe"]=2, ["Kohle"]=1, ["K\195\182nigsblut"]= 4})--, FIZ_LIMIT_TYPE_HERB)
	FIZ_AddQuest("Thorium Brotherhood", 4, 4, "[45] Nachschub an feurigem Fluxus: Eisen", 25, {["Incendosaurierschuppe"]=2, ["Kohle"]=1, ["Eisenbarren"] = 4})--, FIZ_LIMIT_TYPE_MINE)
	FIZ_AddQuest("Thorium Brotherhood", 4, 4, "[45] Nachschub an feurigem Fluxus: Schweres Leder", 25, {["Incendosaurierschuppe"]=2, ["Kohle"]=1, ["Schweres Leder"] = 10})--, FIZ_LIMIT_TYPE_SKIN)
	...
	FIZ_AddInstance("The Ashen Verdict", 4, 8, "Icecrown Citadel 25 (bis Mark'gar)", 1005, false)
end
