...
-- Update message (shown when an update is found)
GS_UpdateMsg = "There is no longer a dedicated host for this addon, ask the owner";

-- Current addon version
-- Ex: 1.23
-- 1 = Base | 2 = Release | 3 = Patch
GS_Version = 1.84;

-- Other addon information
GS_Self,_ = UnitName("player");
GS_Realm = GetRealmName();
...
GS_CommandList = {
	...
	[4] = "/gs level -> Toggles item level information on items.",
	[5] = "/gs ilevel -> Toggle iLevel score.",
	[6] = "/gs compare --> Toggles display of comparative info between you and your target's GearScore.",
	[7] = "/gs dkp --> Toggle display of Net/Spent DKP. Uses QDKP2 format.",
	[8] = "/gs set dkp (number) --> Set max DKP used in your guild.",
	[9] = "/gs tip (some tooltip to be shown) -> Set the tooltip to be shown on mouseover. (40 Character limit)",
	[10] = "/gs version -> Print your current addon version and check for available updates from raid/guild",
	[11] = "/gs ilvlmode -> Only display item levels on player tooltips.",
}
