...
mod:RegisterEventsInCombat(
	"SPELL_AURA_APPLIED 24306 17172 24261 24053",
	"SPELL_AURA_REMOVED 17172 24053",
...
local warnHex2				= mod:NewTargetNoFilterAnnounce(24053, 2, nil, "RemoveMagic|Healer") -- azerothcore bug
...
local specWarnDelusion		= mod:NewSpecialWarningYou(24306, nil, nil, nil, 1, 2)

local timerHex				= mod:NewTargetTimer(5, 17172, nil, "RemoveMagic|Healer", nil, 5, nil, DBM_COMMON_L.MAGIC_ICON)
local timerHex2				= mod:NewTargetTimer(5, 24053, nil, "RemoveMagic|Healer", nil, 5, nil, DBM_COMMON_L.MAGIC_ICON) -- azoerthcore bug
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 24053 and args:IsDestTypePlayer() then
		timerHex2:Start(args.destName)
		warnHex2:Show(args.destName)	
		timerHexCD:Start()
